// imports all required file for this page
import React from 'react';
import Screen from './Screen';
//Import ZingTouch to handle rotation of wheel according to angle
import ZingTouch from 'zingtouch';
import sound from './assets/music/Senorita.mp3'


class Ipod extends React.Component{
// Use constructor to set intial part or value
    constructor(){
        super();
        this.state = {
  ...
  //  Function for handle rotation of wheel
    rotateWheel = () => {
    ...
    /* Function for Move related child like music child is m music and page move to 
     related child page*/
  ...
  // function for go back into homePage
  ...
  //  Function for handle play/pause button
    toggle = () =>{
  ...
  //  Render and dispaly all button to their related function call
    render(){
        return(
            <div style = {styles.ipodContainer}>
                   ...
                   {/* Call Screen child component and pass some data as a props  */}
                <Screen style={styles.backgroung} activeItem={this.state.activeItem} activePage={this.state.activePage} audio={this.state.audio} />

                <div id='inner-container' style = {styles.wheel} onMouseOver={this.rotateWheel}>
                    <div style = {styles.buttonContainer}>
                        <div style = {styles.menuButton}>
                           <p onClick={this.changePageToHomeScreen} ><b>Menu</b></p>
                        </div>
